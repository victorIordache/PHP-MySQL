                ...
                <form action="addReservation.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-4">
                      ...
                      <a href="reserved.php"><input type="button" class="btn btn-primary btn-outline-primary btn-block" value="Already reserved"></a>
                      <a href="updateReservation.php"><input type="button" class="btn btn-primary btn-outline-primary btn-block" value="Update a reservation"></a>
                      <a href="deleteReservation.php"><input type="button" class="btn btn-primary btn-outline-primary btn-block" value="Cancel a reservation"></a>
                    </div>
                  </div>
                </form>
              </div>
